			...
			<div class="new-game">
				<c:choose>
				    <c:when test="${user.isRegistered()}">
				        <form name="create-game-room" method="POST" action="CreateGameServlet">
							<input class="yellow-button" style="width:280px" type="submit" name="create-game" value="Create a new game" />
						</form>
				    </c:when>    
				    <c:otherwise>
						<input class="yellow-button" style="background-color:#F0F0F0;width:280px" type="submit" name="create-game" value="Create a new game" />
				    </c:otherwise>
				</c:choose>
